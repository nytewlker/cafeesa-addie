  ...
  <div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1>Search Results against '<?php echo $_POST['searchdata'];?>'</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php 
                      ...
                      $query = mysqli_query($con, "SELECT * FROM tblbookings WHERE bookingNo LIKE '%$sdata%' OR phoneNumber LIKE '%$sdata%'");
                      $cnt = 1;
